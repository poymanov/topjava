...
public class MealsUtil {
    ...
    public static List<MealTo> getWithExcessWithFilter(Collection<Meal> meals, int caloriesPerDay, Predicate<Meal> filter) {
        return getFilteredWithExcess(meals, caloriesPerDay, filter);
    }
