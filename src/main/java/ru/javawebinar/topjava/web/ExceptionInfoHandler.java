...
public class ExceptionInfoHandler {
    ...
    public ErrorInfo methodArgumentValidationError(HttpServletRequest req, MethodArgumentNotValidException e) {
        return new ErrorInfo(req.getRequestURL(), VALIDATION_ERROR, ValidationUtil.getErrors(e.getBindingResult()));
    }

    @ResponseStatus(value = HttpStatus.UNPROCESSABLE_ENTITY)  // 422
    @ExceptionHandler({BindException.class})
    public ErrorInfo methodArgumentValidationError(HttpServletRequest req, BindException e) {
        return new ErrorInfo(req.getRequestURL(), VALIDATION_ERROR, ValidationUtil.getErrors(e.getBindingResult()));
    }
